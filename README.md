...
1. **[mirs2502](https://github.com/mirs2502)** による改変版
   - オリジナル(mirs240x)をクローンし、パッケージ統合、コーン認識プログラムの追加などを行ったもの
...
- esp32用ソースコード[mirs-tanq-a-esp](https://github.com/6kam/mirs_tanq_a_esp) (上のソースコードの元になったコード[mirs240x/mirs24_esp32(esp32用ソースコード)](https://github.com/mirs240x/mirs24_esp32.git))
- micro-rosライブラリ。zipでインポート [micro_ros_arduino_mirs240x](https://github.com/mirs240x/micro_ros_arduino_mirs240x)

    ボードの選択についてはArduinoIDEにespのボードマネージャのバージョン2.x系を導入する必要があります。
    また、ボードの選択についてはesp32 dev moduleを使用してください。
